...
import com.jovsq.stitch.network.MultipartPost;
...
public class ResultsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("JOVS", "file path: " + filePath);

        /**
         * Loading the image into the imageview
         */
        PicassoSingleton.getInstance().getPicasso().load(filePath).into(iv_result);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                 ...
                 */
                Toast.makeText(ResultsActivity.this, "Time taken: " + (System.currentTimeMillis() - oldtime1) / 1000.0 + "s", Toast.LENGTH_SHORT).show();
            }
        }.execute();
