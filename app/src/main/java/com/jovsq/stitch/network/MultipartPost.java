package com.jovsq.stitch.network;
...
//    private FileOutputStream fos;
     ...
     * @throws IOException
     */
    public MultipartPost(String mUrl) throws IOException {
...
//                Environment.DIRECTORY_PICTURES),"test.txt");
////        mFile.mkdirs();
...
//        dos = new DataOutputStream(fos);
     ...
     * @throws IOException
     */
    public MultipartPost(String mUrl, JSONObject headers) throws IOException, JSONException {
        URL url = new URL(mUrl);
        conn = (HttpURLConnection) url.openConnection();
        conn.setDoInput(true); // Allow Inputs
        conn.setDoOutput(true); // Allow Outputs
